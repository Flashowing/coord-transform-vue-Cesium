...
export default class CesiumLocal {
    ...
    _homeButtonLang() {
        let _vm = this;
        if (!Cesium.defined(_vm.viewer.homeButton)) {
            return;
        }
    ...
    _sceneModePickerButtonLang() {
        let _vm = this;
        if (!Cesium.defined(_vm.viewer.sceneModePicker)) {
            return;
        }
    ...
    _navigationHelpButtonLang() {
        let _vm = this;
        if (!Cesium.defined(_vm.viewer.navigationHelpButton)) {
            return;
        }
    ...
    _fullScreenButtonLang() {
        let _vm = this;
        if (!Cesium.defined(_vm.viewer.fullscreenButton)) {
            return;
        }
